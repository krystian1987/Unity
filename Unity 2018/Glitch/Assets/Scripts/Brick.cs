...
public class Brick : MonoBehaviour
{
  ...
  void Start ()
  {
    ...
    smokeInstantiate.GetComponent<ParticleSystem>().Stop();
  ...
  void OnCollisionEnter2D(Collision2D collider)
  {
    ...
    if (isBreakable)
    {
      smokeInstantiate.GetComponent<ParticleSystem>().startColor = GetComponent<SpriteRenderer>().color;
      smokeInstantiate.GetComponent<ParticleSystem>().Play();
      HandleHit();
    }
  }
